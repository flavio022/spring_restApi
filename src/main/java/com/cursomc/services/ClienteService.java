...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), passwordEncoder.encode(objDto.getSenha()), objDto.getCpfOuCnpj(),
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityViolationException("Não é possível excluir pq há entidades relacionadas");
		}
	}
